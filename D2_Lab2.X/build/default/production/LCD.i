...
void pulse_E(void);
void ini_LCD(void);
void w_Instruction(uint8_t instruction);
void w_Char(unsigned char data);
void w_String(unsigned char data[]);
...
void ini_LCD(void)
{
    ...
    w_Instruction(0b00111000);

    _delay((unsigned long)((4)*(4000000/4000.0)));
    w_Instruction(0b00001100);
    return;
}
...
void set_Cursor(uint8_t line, uint8_t pos)
{
    uint8_t direction = 0b10000000;
    line = line<<6;
    direction = direction | line | pos;
    w_Instruction(direction);
    return;
}
